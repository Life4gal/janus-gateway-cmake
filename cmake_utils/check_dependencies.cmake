...
if (JANUS_TRANSPORT_WEBSOCKETS OR JANUS_HANDLER_WEBSOCKETS)
	...
	if (DEFINED CACHE{CACHE_LIBWEBSOCKETS})
		if (JANUS_TRANSPORT_WEBSOCKETS)
			janus_append_extra_libraries(
					...
					# link_libraries
					"$CACHE{CACHE_LIBWEBSOCKETS_LIBRARIES};$CACHE{CACHE_GIO_LIBRARIES}"
					# link_directories
					"$CACHE{CACHE_LIBWEBSOCKETS_DIRECTORIES};$CACHE{CACHE_GIO_DIRECTORIES}"
					# include_directories
					"$CACHE{CACHE_LIBWEBSOCKETS_INCLUDE_DIRECTORIES};$CACHE{CACHE_GIO_INCLUDE_DIRECTORIES}"
					# compile_flags
					"$CACHE{CACHE_LIBWEBSOCKETS_COMPILE_FLAGS};$CACHE{CACHE_GIO_COMPILE_FLAGS}"
					# ld_flags
					"$CACHE{CACHE_LIBWEBSOCKETS_LD_FLAGS};$CACHE{CACHE_GIO_LD_FLAGS}"
			)
	...
	endif (DEFINED CACHE{CACHE_LIBWEBSOCKETS})
...
if (JANUS_TRANSPORT_MQTT OR JANUS_HANDLER_MQTT)
	...
	if (DEFINED CACHE{CACHE_PAHO_MQTT3AS})
		if (JANUS_TRANSPORT_MQTT)
			janus_append_extra_libraries(
					...
					# link_libraries
					"$CACHE{CACHE_PAHO_MQTT3AS_LIBRARIES};$CACHE{CACHE_GIO_LIBRARIES}"
					# link_directories
					"$CACHE{CACHE_PAHO_MQTT3AS_DIRECTORIES};$CACHE{CACHE_GIO_DIRECTORIES}"
					# include_directories
					"$CACHE{CACHE_PAHO_MQTT3AS_INCLUDE_DIRECTORIES};$CACHE{CACHE_GIO_INCLUDE_DIRECTORIES}"
					# compile_flags
					"$CACHE{CACHE_PAHO_MQTT3AS_COMPILE_FLAGS};$CACHE{CACHE_GIO_COMPILE_FLAGS}"
					# ld_flags
					"$CACHE{CACHE_PAHO_MQTT3AS_LD_FLAGS};$CACHE{CACHE_GIO_LD_FLAGS}"
			)
	...
	endif (DEFINED CACHE{CACHE_PAHO_MQTT3AS})
